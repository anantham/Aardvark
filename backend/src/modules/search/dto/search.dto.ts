...
import { StoryCategory, StoryLength, StoryComplexity, ContentWarning } from '@aardvark/shared';
...
export class SearchStoriesDto {
  ...
  @ApiPropertyOptional({ description: 'Exclude content warnings', type: [String] })
  @IsOptional()
  @IsArray()
  @IsEnum(ContentWarning, { each: true })
  excludeWarnings?: ContentWarning[];

  @ApiPropertyOptional({ description: 'Filter by story length', enum: StoryLength })
  @IsOptional()
  @IsEnum(StoryLength)
  length?: StoryLength;

  @ApiPropertyOptional({ description: 'Filter by complexity', enum: StoryComplexity })
  @IsOptional()
  ...
  @IsOptional()
  @IsString()
  sortBy?: 'relevance' | 'rating' | 'views' | 'recent' | 'trending' = 'relevance';
}
...
export class AutocompleteDto {
  ...
  @ApiPropertyOptional({ description: 'Type of autocomplete', enum: ['story', 'user', 'tag'] })
  @IsOptional()
  @IsString()
