...
export class CreateThreadDto {
  ...
  @ApiProperty({ description: 'Thread content (markdown)', minLength: 10, maxLength: 10000 })
  @IsString()
  @MinLength(10)
  @MaxLength(10000)
  content: string;
...
export class UpdateThreadDto {
  @ApiPropertyOptional({ description: 'Thread title', minLength: 5, maxLength: 200 })
  @IsOptional()
  @IsString()
  @MinLength(5)
  @MaxLength(200)
  ...
  @ApiPropertyOptional({ description: 'Thread content (markdown)', minLength: 10, maxLength: 10000 })
  @IsOptional()
  @IsString()
  @MinLength(10)
  @MaxLength(10000)
...
export class CreatePostDto {
  @ApiProperty({ description: 'Post content (markdown)', minLength: 1, maxLength: 10000 })
  @IsString()
  @MinLength(1)
  @MaxLength(10000)
  content: string;
...
export class UpdatePostDto {
  @ApiProperty({ description: 'Updated post content (markdown)', minLength: 1, maxLength: 10000 })
  @IsString()
  @MinLength(1)
  @MaxLength(10000)
  content: string;
...
export class ThreadQueryDto {
  @ApiPropertyOptional({ description: 'Filter by category', enum: ForumCategory })
  @IsOptional()
  @IsEnum(ForumCategory)
  category?: ForumCategory;
  ...
  @ApiPropertyOptional({ description: 'Sort by', enum: ['recent', 'oldest', 'replies', 'views'] })
  @IsOptional()
  @IsString()
...
export class PostQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Sort by', enum: ['oldest', 'newest', 'votes'] })
  @IsOptional()
  @IsString()
